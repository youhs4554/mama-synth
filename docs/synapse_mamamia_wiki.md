# Crawled Page: Synapse Wiki (syn60868042)
- **Source URL:** [https://www.synapse.org/Synapse:syn60868042/wiki/628716](https://www.synapse.org/Synapse:syn60868042/wiki/628716)

---

![mamamia_logo_web.png](./images/syn_143423115_mamamia_logo_web.png)    
<br/><br/>
# MAMA-MIA: A large-scale multicenter breast cancer DCE-MRI benchmark dataset with expert segmentations
[![Sci Data](./images/51291871_Sci._Data_Paper-Link-b31b1b.svg)](https://doi.org/10.1038/s41597-025-04707-4) ![MAMAMIA](./images/85739120_GitHub-MAMA--MIA-1258.svg) [![License](./images/13395538_License-CC--BY--NC--40-647.svg)](https://creativecommons.org/licenses/by-nc/4.0/)
...
The **MAMA-MIA Challenge** paper is now available on arXiv: 🔗 https://arxiv.org/abs/2603.01250 
...
![dataset_info_no_header.png](./images/syn_143393969_dataset_info_no_header.png)

## Expert Segmentations
![segmentation_process.png](./images/syn_143422872_segmentation_process.png)
...
## Collaborators
![collaborators.png](./images/syn_143422901_collaborators.png)

Thank you for using our dataset and pretrained model! If you have any questions or issues, please feel free to contact us.
